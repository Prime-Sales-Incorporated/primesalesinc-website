...
export default function Gallery() {
  ...
  return (
    <section className="relative py-24 px-4 min-h-screen bg-background-light dark:bg-background-dark overflow-hidden">
      ...
      <p className="text-lg text-center font-sans leading-normal mt-8 text-white">
        {" "}
        Scroll horizontally
      </p>
      <Footer />
