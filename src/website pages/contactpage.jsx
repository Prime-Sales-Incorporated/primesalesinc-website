...
export default function ContactPage() {
  ...
  return (
    <main className="bg-white dark:bg-slate-900 text-gray-900 dark:text-white font-sans antialiased transition-colors duration-200">
      {/* Hero */}
      <Header dark={dark} setDark={setDark} />
      <div className="relative bg-grid border-b border-gray-200 dark:border-gray-800">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white dark:to-slate-900 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 space-y-8 lg:pl-8">
                  ...
                  <div>
                    ...
                    <ul className="mt-4 space-y-3 text-sm font-semibold">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        or
                        <img src="/ig.png" alt="Facebook" className="w-4 h-4" />
                      </li>
                    </ul>
                  </div>
                </li>
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">Parañaque</p>
